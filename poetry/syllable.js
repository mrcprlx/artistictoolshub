(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.syllable = factory());
	...
	var normalizeStrings$1 = {exports: {}};
	...
	var normalizeStrings = normalizeStrings$1.exports;

	var hasRequiredNormalizeStrings;

	function requireNormalizeStrings () {
		if (hasRequiredNormalizeStrings) return normalizeStrings$1.exports;
		hasRequiredNormalizeStrings = 1;
		(function (module) {
			(function(global, factory) {
			  if (module.exports) {
			...
			} (typeof window !== 'undefined' ? window : normalizeStrings, function (window, document) {
		...
		return normalizeStrings$1.exports;
	}

	var normalizeStringsExports = requireNormalizeStrings();
	var normalize = /*@__PURE__*/getDefaultExportFromCjs(normalizeStringsExports);
