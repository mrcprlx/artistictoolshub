function generateForm() {
    ...
    resultsDiv.innerHTML = `
        <h3>${randomForm.name.charAt(0).toUpperCase() + randomForm.name.slice(1)}</h3>
        <p><strong>Description:</strong> ${randomForm.description}</p>
        <p><strong>Example:</strong> ${randomForm.example}</p>
    `;
}